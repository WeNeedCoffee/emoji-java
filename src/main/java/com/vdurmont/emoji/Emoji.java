...
public class Emoji {
	 ...
	 * @param supportsFitzpatrick Whether the emoji supports Fitzpatrick
	 *                            modifiers
	...
	protected Emoji(String description, boolean supportsFitzpatrick, List<String> aliases, List<String> tags, byte... bytes) {
		...
		int count = 0;
		try {
			unicode = new String(bytes, "UTF-8");
	...
	public String toString() {
		return "Emoji{" + "description='" + description + '\'' + ", supportsFitzpatrick=" + supportsFitzpatrick + ", aliases=" + aliases + ", tags=" + tags + ", unicode='" + unicode + '\'' + ", htmlDec='" + htmlDec + '\'' + ", htmlHex='" + htmlHex + '\'' + '}';
	}
}
